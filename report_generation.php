...
if(isset($_POST['sort']))
{
 ...
 enquiry.amt_emd, enquiry.estimated_cost ,
 products.product_name, products.product_qty,products.make FROM enquiry INNER JOIN  products ON
  enquiry.tender_id= products.tender_id  WHERE `submission_date` BETWEEN '$from' AND '$to' ORDER BY `submission_date` ASC ,`client_name` ASC";
...
{
  $second_sort= $_POST['second_sort'];
  $find= $_POST['find'];

  $query1="SELECT enquiry.submission_date , enquiry.client_name , enquiry.tender_id ,enquiry.tender_c,
  enquiry.amt_emd, enquiry.estimated_cost ,
  products.product_name, products.product_qty,products.make FROM enquiry INNER JOIN  products ON
   enquiry.tender_id= products.tender_id  WHERE `submission_date` BETWEEN '$from1' AND '$to1'  AND `$second_sort` ='$find' ORDER BY `submission_date` ASC" ;
